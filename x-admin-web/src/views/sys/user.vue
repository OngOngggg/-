...
<!--          </template>-->
<!--        </el-table-column>-->
        <el-table-column prop="id" label="床位号" width="80" />
        <el-table-column prop="username" label="姓名" width="180" />
        <el-table-column prop="phone" label="电话" width="180" />
        <el-table-column prop="status" label="精神状态" width="180">
          <template slot-scope="scope">
            <el-tag v-if="scope.row.status == 1">正常</el-tag>
            <el-tag v-else type="danger">疯狂</el-tag>
          </template>
        </el-table-column>
    ...
    <el-dialog @close="clearForm" :title=title :visible.sync="dialogFormVisible">
      <el-form :model="userForm" ref="userFormRef" :rules="rules">
        ...
        <el-form-item label="精神状态" :label-width="formLabelWidth">
          <el-switch v-model="userForm.status" :active-value="1" :inactive-value="0" active-color="#13ce66" />
        </el-form-item>
